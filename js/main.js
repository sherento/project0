...
$("#line1, #line2").removeClass('initial');
$("#line3, #line4").removeClass('initial');
...
const winner = function() {
    ...
    if (gameBoard[0][0] === gameBoard[0][1] && gameBoard[0][2] === gameBoard[0][1]) {
      ...
      //start button to animate grid lines
      //set time outs between lines setTimeout(function(){
      //}, 1000);
